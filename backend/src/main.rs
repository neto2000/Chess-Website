...
async fn get_figure_dict() -> impl IntoResponse
{
    ...
    let pawn = json!({"start-pos": 5, "image": "Pawn.png", "n":1, "ne":0, "e":0,"se":0,"s":0,"sw":0,"w":0,"nw":0 , "auto-fill":false});

    let queen = json!({"start-pos": 5, "image": "Queen.png", "n":8, "ne":8, "e":8,"se":8,"s":8,"sw":8,"w":8,"nw":8 , "auto-fill":true});

    let king = json!({"start-pos": 5, "image": "King.png", "n":1, "ne":1, "e":1,"se":1,"s":1,"sw":1,"w":1,"nw":1 , "auto-fill":false});

    let bishop = json!({"start-pos": 5, "image": "Bishop.png", "n":0, "ne":8, "e":0,"se":8,"s":0,"sw":8,"w":0,"nw":8 , "auto-fill":true});


    // !! implement that it is not 2 in one direction but two in the direction and 1 left and right (in JS) !!
    let knight = json!({"start-pos": 5, "image": "Knight.png", "n":2, "ne":0, "e":2,"se":0,"s":2,"sw":0,"w":2,"nw":0 , "auto-fill":false});

    let rook = json!({"start-pos": 5, "image": "Rook.png", "n":8, "ne":0, "e":8,"se":0,"s":8,"sw":0,"w":8,"nw":0 , "auto-fill":true});
